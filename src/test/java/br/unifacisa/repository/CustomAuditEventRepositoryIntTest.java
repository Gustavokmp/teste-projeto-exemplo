...
import br.unifacisa.config.audit.AuditEventConverter;
import br.unifacisa.domain.PersistentAuditEvent;
...
import static br.unifacisa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
