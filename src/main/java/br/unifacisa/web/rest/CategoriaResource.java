...
public class CategoriaResource {
    ...
    @Timed
    public ResponseEntity<List<Categoria>> getAllCategorias(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, String.format("/api/categorias?eagerload=%b", eagerload));
